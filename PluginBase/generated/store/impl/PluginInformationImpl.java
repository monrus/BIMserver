 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.PluginInformationImpl#getName <em>Name</em>}</li>
 *   <li>{@link store.impl.PluginInformationImpl#getType <em>Type</em>}</li>
 *   <li>{@link store.impl.PluginInformationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link store.impl.PluginInformationImpl#isEnabled <em>Enabled</em>}</li>
 *   <li>{@link store.impl.PluginInformationImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link store.impl.PluginInformationImpl#isInstallForAllUsers <em>Install For All Users</em>}</li>
 *   <li>{@link store.impl.PluginInformationImpl#isInstallForNewUsers <em>Install For New Users</em>}</li>
 * </ul>
 *
 * @generated
 */
