 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.PluginBundleVersionImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link store.impl.PluginBundleVersionImpl#getType <em>Type</em>}</li>
 *   <li>{@link store.impl.PluginBundleVersionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link store.impl.PluginBundleVersionImpl#isMismatch <em>Mismatch</em>}</li>
 *   <li>{@link store.impl.PluginBundleVersionImpl#getRepository <em>Repository</em>}</li>
 *   <li>{@link store.impl.PluginBundleVersionImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link store.impl.PluginBundleVersionImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link store.impl.PluginBundleVersionImpl#getIcon <em>Icon</em>}</li>
 *   <li>{@link store.impl.PluginBundleVersionImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link store.impl.PluginBundleVersionImpl#getName <em>Name</em>}</li>
 *   <li>{@link store.impl.PluginBundleVersionImpl#getDate <em>Date</em>}</li>
 * </ul>
 *
 * @generated
 */
