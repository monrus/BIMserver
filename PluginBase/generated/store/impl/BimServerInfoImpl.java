 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.BimServerInfoImpl#getCurrentVersion <em>Current Version</em>}</li>
 *   <li>{@link store.impl.BimServerInfoImpl#getCurrentDate <em>Current Date</em>}</li>
 *   <li>{@link store.impl.BimServerInfoImpl#getSchemaVersion <em>Schema Version</em>}</li>
 *   <li>{@link store.impl.BimServerInfoImpl#getLatestDate <em>Latest Date</em>}</li>
 *   <li>{@link store.impl.BimServerInfoImpl#getLatestVersion <em>Latest Version</em>}</li>
 *   <li>{@link store.impl.BimServerInfoImpl#getProjects <em>Projects</em>}</li>
 *   <li>{@link store.impl.BimServerInfoImpl#getRevisions <em>Revisions</em>}</li>
 *   <li>{@link store.impl.BimServerInfoImpl#getUsers <em>Users</em>}</li>
 *   <li>{@link store.impl.BimServerInfoImpl#getCheckouts <em>Checkouts</em>}</li>
 *   <li>{@link store.impl.BimServerInfoImpl#getServerLogUrl <em>Server Log Url</em>}</li>
 *   <li>{@link store.impl.BimServerInfoImpl#getStarted <em>Started</em>}</li>
 * </ul>
 *
 * @generated
 */
