 ...
 *   <li>{@link store.impl.ServerSettingsImpl#getEmailSenderName <em>Email Sender Name</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getSiteAddress <em>Site Address</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#isGenerateGeometryOnCheckin <em>Generate Geometry On Checkin</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#isAllowOnlyWhitelisted <em>Allow Only Whitelisted</em>}</li>
 ...
 *   <li>{@link store.impl.ServerSettingsImpl#getWebModules <em>Web Modules</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getWebModule <em>Web Module</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getServiceRepositoryUrl <em>Service Repository Url</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#isSendEmailOnNewRevision <em>Send Email On New Revision</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getSessionTimeOutSeconds <em>Session Time Out Seconds</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getSmtpUsername <em>Smtp Username</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getSmtpPassword <em>Smtp Password</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getSmtpPort <em>Smtp Port</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getSmtpProtocol <em>Smtp Protocol</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#isReuseGeometry <em>Reuse Geometry</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#isAllowCreateValidatedUser <em>Allow Create Validated User</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getRenderEngineProcesses <em>Render Engine Processes</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#isPluginStrictVersionChecking <em>Plugin Strict Version Checking</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getName <em>Name</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getIcon <em>Icon</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#isStoreLastLogin <em>Store Last Login</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#isStoreServiceRuns <em>Store Service Runs</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#isOptimizeMappedItems <em>Optimize Mapped Items</em>}</li>
 *   <li>{@link store.impl.ServerSettingsImpl#getDefaultRenderEnginePlugin <em>Default Render Engine Plugin</em>}</li>
 * </ul>
 *
 * @generated
 */
