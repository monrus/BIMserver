 ...
 *   <li>{@link store.impl.RevisionImpl#getService <em>Service</em>}</li>
 *   <li>{@link store.impl.RevisionImpl#isHasGeometry <em>Has Geometry</em>}</li>
 *   <li>{@link store.impl.RevisionImpl#getBounds <em>Bounds</em>}</li>
 *   <li>{@link store.impl.RevisionImpl#getBoundsUntransformed <em>Bounds Untransformed</em>}</li>
 *   <li>{@link store.impl.RevisionImpl#getBoundsMm <em>Bounds Mm</em>}</li>
 *   <li>{@link store.impl.RevisionImpl#getBoundsUntransformedMm <em>Bounds Untransformed Mm</em>}</li>
 *   <li>{@link store.impl.RevisionImpl#getServicesLinked <em>Services Linked</em>}</li>
 *   <li>{@link store.impl.RevisionImpl#getDensityCollection <em>Density Collection</em>}</li>
 *   <li>{@link store.impl.RevisionImpl#getNrPrimitives <em>Nr Primitives</em>}</li>
 * </ul>
 *
 * @generated
 */
