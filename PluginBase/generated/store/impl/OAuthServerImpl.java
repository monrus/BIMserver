 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.OAuthServerImpl#getRegistrationUrl <em>Registration Url</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#getClientId <em>Client Id</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#getClientSecret <em>Client Secret</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#getClientName <em>Client Name</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#getClientIcon <em>Client Icon</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#getClientUrl <em>Client Url</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#getClientDescription <em>Client Description</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#getRedirectUrl <em>Redirect Url</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#getExpiresAt <em>Expires At</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#getIssuedAt <em>Issued At</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#isIncoming <em>Incoming</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#getApiUrl <em>Api Url</em>}</li>
 *   <li>{@link store.impl.OAuthServerImpl#getRegistrationEndpoint <em>Registration Endpoint</em>}</li>
 * </ul>
 *
 * @generated
 */
