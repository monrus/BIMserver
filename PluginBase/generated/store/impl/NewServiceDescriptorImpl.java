 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.NewServiceDescriptorImpl#getName <em>Name</em>}</li>
 *   <li>{@link store.impl.NewServiceDescriptorImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link store.impl.NewServiceDescriptorImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link store.impl.NewServiceDescriptorImpl#getAuthorizationUrl <em>Authorization Url</em>}</li>
 *   <li>{@link store.impl.NewServiceDescriptorImpl#getTokenUrl <em>Token Url</em>}</li>
 *   <li>{@link store.impl.NewServiceDescriptorImpl#getResourceUrl <em>Resource Url</em>}</li>
 *   <li>{@link store.impl.NewServiceDescriptorImpl#getRegisterUrl <em>Register Url</em>}</li>
 *   <li>{@link store.impl.NewServiceDescriptorImpl#getInputs <em>Inputs</em>}</li>
 *   <li>{@link store.impl.NewServiceDescriptorImpl#getOutputs <em>Outputs</em>}</li>
 * </ul>
 *
 * @generated
 */
