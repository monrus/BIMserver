 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.DensityImpl#getType <em>Type</em>}</li>
 *   <li>{@link store.impl.DensityImpl#getGeometryInfoId <em>Geometry Info Id</em>}</li>
 *   <li>{@link store.impl.DensityImpl#getTrianglesBelow <em>Triangles Below</em>}</li>
 *   <li>{@link store.impl.DensityImpl#getTrianglesAbove <em>Triangles Above</em>}</li>
 *   <li>{@link store.impl.DensityImpl#getVolume <em>Volume</em>}</li>
 *   <li>{@link store.impl.DensityImpl#getDensity <em>Density</em>}</li>
 * </ul>
 *
 * @generated
 */
