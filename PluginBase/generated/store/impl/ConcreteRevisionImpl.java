 ...
 *   <li>{@link store.impl.ConcreteRevisionImpl#isClear <em>Clear</em>}</li>
 ...
 *   <li>{@link store.impl.ConcreteRevisionImpl#getIfcHeader <em>Ifc Header</em>}</li>
 *   <li>{@link store.impl.ConcreteRevisionImpl#getBounds <em>Bounds</em>}</li>
 *   <li>{@link store.impl.ConcreteRevisionImpl#getBoundsUntransformed <em>Bounds Untransformed</em>}</li>
 *   <li>{@link store.impl.ConcreteRevisionImpl#getOidCounters <em>Oid Counters</em>}</li>
 *   <li>{@link store.impl.ConcreteRevisionImpl#getMultiplierToMm <em>Multiplier To Mm</em>}</li>
 *   <li>{@link store.impl.ConcreteRevisionImpl#getDensityCollection <em>Density Collection</em>}</li>
 * </ul>
 *
 * @generated
 */
