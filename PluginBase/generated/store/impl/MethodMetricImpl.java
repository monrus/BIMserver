 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.MethodMetricImpl#getName <em>Name</em>}</li>
 *   <li>{@link store.impl.MethodMetricImpl#getNrCalls <em>Nr Calls</em>}</li>
 *   <li>{@link store.impl.MethodMetricImpl#getLastCall <em>Last Call</em>}</li>
 *   <li>{@link store.impl.MethodMetricImpl#getAverageMs <em>Average Ms</em>}</li>
 *   <li>{@link store.impl.MethodMetricImpl#getShortestMs <em>Shortest Ms</em>}</li>
 *   <li>{@link store.impl.MethodMetricImpl#getLongestMs <em>Longest Ms</em>}</li>
 * </ul>
 *
 * @generated
 */
