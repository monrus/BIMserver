 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.SystemInfoImpl#getCpucores <em>Cpucores</em>}</li>
 *   <li>{@link store.impl.SystemInfoImpl#getDatetime <em>Datetime</em>}</li>
 *   <li>{@link store.impl.SystemInfoImpl#getOsname <em>Osname</em>}</li>
 *   <li>{@link store.impl.SystemInfoImpl#getOsversion <em>Osversion</em>}</li>
 *   <li>{@link store.impl.SystemInfoImpl#getUserName <em>User Name</em>}</li>
 *   <li>{@link store.impl.SystemInfoImpl#getUserHome <em>User Home</em>}</li>
 *   <li>{@link store.impl.SystemInfoImpl#getUserDir <em>User Dir</em>}</li>
 * </ul>
 *
 * @generated
 */
