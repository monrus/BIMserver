 ...
 *   <li>{@link store.impl.ServiceDescriptorImpl#getCompanyUrl <em>Company Url</em>}</li>
 *   <li>{@link store.impl.ServiceDescriptorImpl#getTokenUrl <em>Token Url</em>}</li>
 *   <li>{@link store.impl.ServiceDescriptorImpl#getNewProfileUrl <em>New Profile Url</em>}</li>
 *   <li>{@link store.impl.ServiceDescriptorImpl#getRegisterUrl <em>Register Url</em>}</li>
 *   <li>{@link store.impl.ServiceDescriptorImpl#getAuthorizeUrl <em>Authorize Url</em>}</li>
 * </ul>
 *
 * @generated
 */
