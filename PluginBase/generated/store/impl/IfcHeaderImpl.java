 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.IfcHeaderImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link store.impl.IfcHeaderImpl#getImplementationLevel <em>Implementation Level</em>}</li>
 *   <li>{@link store.impl.IfcHeaderImpl#getFilename <em>Filename</em>}</li>
 *   <li>{@link store.impl.IfcHeaderImpl#getTimeStamp <em>Time Stamp</em>}</li>
 *   <li>{@link store.impl.IfcHeaderImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link store.impl.IfcHeaderImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link store.impl.IfcHeaderImpl#getPreProcessorVersion <em>Pre Processor Version</em>}</li>
 *   <li>{@link store.impl.IfcHeaderImpl#getOriginatingSystem <em>Originating System</em>}</li>
 *   <li>{@link store.impl.IfcHeaderImpl#getIfcSchemaVersion <em>Ifc Schema Version</em>}</li>
 *   <li>{@link store.impl.IfcHeaderImpl#getAuthorization <em>Authorization</em>}</li>
 * </ul>
 *
 * @generated
 */
