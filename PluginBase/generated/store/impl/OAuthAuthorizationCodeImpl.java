 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.OAuthAuthorizationCodeImpl#getOauthServer <em>Oauth Server</em>}</li>
 *   <li>{@link store.impl.OAuthAuthorizationCodeImpl#getCode <em>Code</em>}</li>
 *   <li>{@link store.impl.OAuthAuthorizationCodeImpl#getAuthorization <em>Authorization</em>}</li>
 *   <li>{@link store.impl.OAuthAuthorizationCodeImpl#getUser <em>User</em>}</li>
 *   <li>{@link store.impl.OAuthAuthorizationCodeImpl#getIssued <em>Issued</em>}</li>
 * </ul>
 *
 * @generated
 */
