 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.NewServiceImpl#getName <em>Name</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getAuthorizationUrl <em>Authorization Url</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getTokenUrl <em>Token Url</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getResourceUrl <em>Resource Url</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getRegisterUrl <em>Register Url</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getInput <em>Input</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getOauthCode <em>Oauth Code</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getSerializer <em>Serializer</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getAction <em>Action</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getAccessToken <em>Access Token</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getProject <em>Project</em>}</li>
 *   <li>{@link store.impl.NewServiceImpl#getStateJson <em>State Json</em>}</li>
 * </ul>
 *
 * @generated
 */
