 ...
 *   <li>{@link store.impl.UserSettingsImpl#getRenderEngines <em>Render Engines</em>}</li>
 *   <li>{@link store.impl.UserSettingsImpl#getDeserializers <em>Deserializers</em>}</li>
 *   <li>{@link store.impl.UserSettingsImpl#getQueryEngines <em>Query Engines</em>}</li>
 *   <li>{@link store.impl.UserSettingsImpl#getModelMergers <em>Model Mergers</em>}</li>
 *   <li>{@link store.impl.UserSettingsImpl#getModelCompares <em>Model Compares</em>}</li>
 ...
 *   <li>{@link store.impl.UserSettingsImpl#getDefaultRenderEngine <em>Default Render Engine</em>}</li>
