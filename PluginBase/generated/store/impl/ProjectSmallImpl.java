 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.ProjectSmallImpl#getName <em>Name</em>}</li>
 *   <li>{@link store.impl.ProjectSmallImpl#getParentId <em>Parent Id</em>}</li>
 *   <li>{@link store.impl.ProjectSmallImpl#getState <em>State</em>}</li>
 *   <li>{@link store.impl.ProjectSmallImpl#getNrRevisions <em>Nr Revisions</em>}</li>
 *   <li>{@link store.impl.ProjectSmallImpl#getNrSubProjects <em>Nr Sub Projects</em>}</li>
 *   <li>{@link store.impl.ProjectSmallImpl#isHasCheckinRights <em>Has Checkin Rights</em>}</li>
 *   <li>{@link store.impl.ProjectSmallImpl#getLastRevisionId <em>Last Revision Id</em>}</li>
 *   <li>{@link store.impl.ProjectSmallImpl#getSchema <em>Schema</em>}</li>
 * </ul>
 *
 * @generated
 */
