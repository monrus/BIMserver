 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.PluginDescriptorImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link store.impl.PluginDescriptorImpl#getPluginInterfaceClassName <em>Plugin Interface Class Name</em>}</li>
 *   <li>{@link store.impl.PluginDescriptorImpl#getConfigurations <em>Configurations</em>}</li>
 *   <li>{@link store.impl.PluginDescriptorImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link store.impl.PluginDescriptorImpl#isInstallForNewUsers <em>Install For New Users</em>}</li>
 *   <li>{@link store.impl.PluginDescriptorImpl#getPluginBundleVersion <em>Plugin Bundle Version</em>}</li>
 *   <li>{@link store.impl.PluginDescriptorImpl#getSettings <em>Settings</em>}</li>
 * </ul>
 *
 * @generated
 */
