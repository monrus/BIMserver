 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.JavaInfoImpl#getHeapTotal <em>Heap Total</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getHeapUsed <em>Heap Used</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getHeapFree <em>Heap Free</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getHeapMax <em>Heap Max</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getThreads <em>Threads</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaHome <em>Java Home</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaVersion <em>Java Version</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaVendor <em>Java Vendor</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaVendorurl <em>Java Vendorurl</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavavmVersion <em>Javavm Version</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavavmVendor <em>Javavm Vendor</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavavmName <em>Javavm Name</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaspecVersion <em>Javaspec Version</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaspecVendor <em>Javaspec Vendor</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaspecName <em>Javaspec Name</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaClassVersion <em>Java Class Version</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaClasspath <em>Java Classpath</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaLibrarypath <em>Java Librarypath</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaIoTmp <em>Java Io Tmp</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaExtdir <em>Java Extdir</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaFileSeparator <em>Java File Separator</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaPathSeparator <em>Java Path Separator</em>}</li>
 *   <li>{@link store.impl.JavaInfoImpl#getJavaLineSeparator <em>Java Line Separator</em>}</li>
 * </ul>
 *
 * @generated
 */
