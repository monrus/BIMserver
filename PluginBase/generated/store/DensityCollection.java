 ...
 * </p>
 * <ul>
 *   <li>{@link store.DensityCollection#getDensities <em>Densities</em>}</li>
 * </ul>
 *
 * @see store.StorePackage#getDensityCollection()
 * @model
 * @extends IdEObject
 * @generated
 */
public interface DensityCollection extends IdEObject {
	 ...
	 * The list contents are of type {@link store.Density}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Densities</em>' reference list.
	 * @see store.StorePackage#getDensityCollection_Densities()
