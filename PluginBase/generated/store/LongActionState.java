 ...
 * </p>
 * <ul>
 *   <li>{@link store.LongActionState#getStart <em>Start</em>}</li>
 *   <li>{@link store.LongActionState#getEnd <em>End</em>}</li>
 *   <li>{@link store.LongActionState#getProgress <em>Progress</em>}</li>
 *   <li>{@link store.LongActionState#getState <em>State</em>}</li>
 *   <li>{@link store.LongActionState#getTitle <em>Title</em>}</li>
 *   <li>{@link store.LongActionState#getStage <em>Stage</em>}</li>
 ...
 *   <li>{@link store.LongActionState#getTopicId <em>Topic Id</em>}</li>
 * </ul>
 *
...
public interface LongActionState extends IdEObject {
	 ...
	 * @see #setStart(Date)
	 * @see store.StorePackage#getLongActionState_Start()
	 * @model
	 * @generated
	 */
	Date getStart();
	...
	/**
	 * Sets the value of the '{@link store.LongActionState#getStart <em>Start</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setEnd(Date)
	 * @see store.StorePackage#getLongActionState_End()
	 * @model
	 * @generated
	 */
	Date getEnd();
	...
	/**
	 * Sets the value of the '{@link store.LongActionState#getEnd <em>End</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTitle(String)
	 * @see store.StorePackage#getLongActionState_Title()
	 * @model
	 * @generated
	 */
	String getTitle();
	...
	/**
	 * Sets the value of the '{@link store.LongActionState#getTitle <em>Title</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setStage(int)
	 * @see store.StorePackage#getLongActionState_Stage()
	 * @model
	 * @generated
	 */
	int getStage();
	...
	/**
	 * Sets the value of the '{@link store.LongActionState#getStage <em>Stage</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTopicId(long)
	 * @see store.StorePackage#getLongActionState_TopicId()
	 * @model
	 * @generated
	 */
	long getTopicId();
	...
	/**
	 * Sets the value of the '{@link store.LongActionState#getTopicId <em>Topic Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
