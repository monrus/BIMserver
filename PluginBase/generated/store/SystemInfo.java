 ...
 * </p>
 * <ul>
 *   <li>{@link store.SystemInfo#getCpucores <em>Cpucores</em>}</li>
 *   <li>{@link store.SystemInfo#getDatetime <em>Datetime</em>}</li>
 *   <li>{@link store.SystemInfo#getOsname <em>Osname</em>}</li>
 *   <li>{@link store.SystemInfo#getOsversion <em>Osversion</em>}</li>
 *   <li>{@link store.SystemInfo#getUserName <em>User Name</em>}</li>
 *   <li>{@link store.SystemInfo#getUserHome <em>User Home</em>}</li>
 *   <li>{@link store.SystemInfo#getUserDir <em>User Dir</em>}</li>
 * </ul>
 *
 * @see store.StorePackage#getSystemInfo()
 * @model
 * @extends IdEObject
 * @generated
 */
public interface SystemInfo extends IdEObject {
	 ...
	 * @see #setCpucores(int)
	 * @see store.StorePackage#getSystemInfo_Cpucores()
	 * @model
	 * @generated
	 */
	int getCpucores();
	...
	/**
	 * Sets the value of the '{@link store.SystemInfo#getCpucores <em>Cpucores</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getSystemInfo_Datetime()
	 * @model
	 * @generated
	 */
	Date getDatetime();
	...
	/**
	 * Sets the value of the '{@link store.SystemInfo#getDatetime <em>Datetime</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getSystemInfo_Osname()
	 * @model
	 * @generated
	 */
	String getOsname();
	...
	/**
	 * Sets the value of the '{@link store.SystemInfo#getOsname <em>Osname</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getSystemInfo_Osversion()
	 * @model
	 * @generated
	 */
	String getOsversion();
	...
	/**
	 * Sets the value of the '{@link store.SystemInfo#getOsversion <em>Osversion</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getSystemInfo_UserName()
	 * @model
	 * @generated
	 */
	String getUserName();
	...
	/**
	 * Sets the value of the '{@link store.SystemInfo#getUserName <em>User Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getSystemInfo_UserHome()
	 * @model
	 * @generated
	 */
	String getUserHome();
	...
	/**
	 * Sets the value of the '{@link store.SystemInfo#getUserHome <em>User Home</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getSystemInfo_UserDir()
	 * @model
	 * @generated
	 */
	String getUserDir();
	...
	/**
	 * Sets the value of the '{@link store.SystemInfo#getUserDir <em>User Dir</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
