 ...
 * </p>
 * <ul>
 *   <li>{@link store.Density#getType <em>Type</em>}</li>
 *   <li>{@link store.Density#getGeometryInfoId <em>Geometry Info Id</em>}</li>
 *   <li>{@link store.Density#getTrianglesBelow <em>Triangles Below</em>}</li>
 *   <li>{@link store.Density#getTrianglesAbove <em>Triangles Above</em>}</li>
 *   <li>{@link store.Density#getVolume <em>Volume</em>}</li>
 *   <li>{@link store.Density#getDensity <em>Density</em>}</li>
 * </ul>
 *
 * @see store.StorePackage#getDensity()
 * @model
 * @extends IdEObject
 * @generated
 */
public interface Density extends IdEObject {
	 ...
	 * @see #setType(String)
	 * @see store.StorePackage#getDensity_Type()
	 * @model
	 * @generated
	 */
	String getType();
	...
	/**
	 * Sets the value of the '{@link store.Density#getType <em>Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getDensity_GeometryInfoId()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link store.Density#getGeometryInfoId <em>Geometry Info Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getDensity_TrianglesBelow()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link store.Density#getTrianglesBelow <em>Triangles Below</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getDensity_TrianglesAbove()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link store.Density#getTrianglesAbove <em>Triangles Above</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setVolume(float)
	 * @see store.StorePackage#getDensity_Volume()
	 * @model
	 * @generated
	 */
	float getVolume();
	...
	/**
	 * Sets the value of the '{@link store.Density#getVolume <em>Volume</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getDensity_Density()
	 * @model
	 * @generated
	 */
	float getDensity();
	...
	/**
	 * Sets the value of the '{@link store.Density#getDensity <em>Density</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
