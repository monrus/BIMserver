 ...
 *   <li>{@link store.SerializerPluginConfiguration#getRenderEngine <em>Render Engine</em>}</li>
 *   <li>{@link store.SerializerPluginConfiguration#isStreaming <em>Streaming</em>}</li>
 * </ul>
 *
...
public interface SerializerPluginConfiguration extends PluginConfiguration {
	 ...
	 * It is bidirectional and its opposite is '{@link store.RenderEnginePluginConfiguration#getSerializers <em>Serializers</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Render Engine</em>' reference.
	 * @see #setRenderEngine(RenderEnginePluginConfiguration)
	 * @see store.StorePackage#getSerializerPluginConfiguration_RenderEngine()
	...
	/**
	 * Sets the value of the '{@link store.SerializerPluginConfiguration#getRenderEngine <em>Render Engine</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getSerializerPluginConfiguration_Streaming()
	 * @model
	 * @generated
	 */
	boolean isStreaming();
	...
	/**
	 * Sets the value of the '{@link store.SerializerPluginConfiguration#isStreaming <em>Streaming</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
