 ...
 * </p>
 * <ul>
 *   <li>{@link store.Tile#getTileId <em>Tile Id</em>}</li>
 *   <li>{@link store.Tile#getNrObjects <em>Nr Objects</em>}</li>
 *   <li>{@link store.Tile#getMinBounds <em>Min Bounds</em>}</li>
 *   <li>{@link store.Tile#getBounds <em>Bounds</em>}</li>
 * </ul>
 *
 * @see store.StorePackage#getTile()
 * @model
 * @extends IdEObject
 * @generated
 */
public interface Tile extends IdEObject {
	 ...
	 * @see #setTileId(int)
	 * @see store.StorePackage#getTile_TileId()
	 * @model
	 * @generated
	 */
	int getTileId();
	...
	/**
	 * Sets the value of the '{@link store.Tile#getTileId <em>Tile Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getTile_NrObjects()
	 * @model
	 * @generated
	 */
	int getNrObjects();
	...
	/**
	 * Sets the value of the '{@link store.Tile#getNrObjects <em>Nr Objects</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getTile_MinBounds()
	...
	/**
	 * Sets the value of the '{@link store.Tile#getMinBounds <em>Min Bounds</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getTile_Bounds()
	 * @model annotation="embedsreference"
	 * @generated
	 */
	Bounds getBounds();
	...
	/**
	 * Sets the value of the '{@link store.Tile#getBounds <em>Bounds</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
