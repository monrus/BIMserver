 ...
 *   <li>{@link store.Revision#getService <em>Service</em>}</li>
 *   <li>{@link store.Revision#isHasGeometry <em>Has Geometry</em>}</li>
 *   <li>{@link store.Revision#getBounds <em>Bounds</em>}</li>
 *   <li>{@link store.Revision#getBoundsUntransformed <em>Bounds Untransformed</em>}</li>
 *   <li>{@link store.Revision#getBoundsMm <em>Bounds Mm</em>}</li>
 *   <li>{@link store.Revision#getBoundsUntransformedMm <em>Bounds Untransformed Mm</em>}</li>
 *   <li>{@link store.Revision#getServicesLinked <em>Services Linked</em>}</li>
 *   <li>{@link store.Revision#getDensityCollection <em>Density Collection</em>}</li>
 *   <li>{@link store.Revision#getNrPrimitives <em>Nr Primitives</em>}</li>
 * </ul>
 *
...
public interface Revision extends IdEObject {
	 ...
	 * @see store.StorePackage#getRevision_Service()
	 * @model
	 * @generated
	 */
	Service getService();
	...
	/**
	 * Sets the value of the '{@link store.Revision#getService <em>Service</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getRevision_HasGeometry()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link store.Revision#isHasGeometry <em>Has Geometry</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getRevision_Bounds()
	...
	/**
	 * Sets the value of the '{@link store.Revision#getBounds <em>Bounds</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getRevision_BoundsUntransformed()
	 * @model annotation="dbembed"
	 *        annotation="embedsreference"
	 *        annotation="hidden"
	 * @generated
	...
	/**
	 * Sets the value of the '{@link store.Revision#getBoundsUntransformed <em>Bounds Untransformed</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getRevision_BoundsMm()
	 * @model annotation="dbembed"
	 *        annotation="embedsreference"
	 *        annotation="hidden"
	 * @generated
	...
	/**
	 * Sets the value of the '{@link store.Revision#getBoundsMm <em>Bounds Mm</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getRevision_BoundsUntransformedMm()
	 * @model annotation="dbembed"
	 *        annotation="embedsreference"
	 *        annotation="hidden"
	 * @generated
	...
	/**
	 * Sets the value of the '{@link store.Revision#getBoundsUntransformedMm <em>Bounds Untransformed Mm</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getRevision_ServicesLinked()
	 * @model
	 * @generated
	 */
	 ...
	 * @see store.StorePackage#getRevision_DensityCollection()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link store.Revision#getDensityCollection <em>Density Collection</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getRevision_NrPrimitives()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link store.Revision#getNrPrimitives <em>Nr Primitives</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
