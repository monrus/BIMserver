 ...
 *   <li>{@link store.ConcreteRevision#isClear <em>Clear</em>}</li>
 *   <li>{@link store.ConcreteRevision#getSummary <em>Summary</em>}</li>
 *   <li>{@link store.ConcreteRevision#getUser <em>User</em>}</li>
 *   <li>{@link store.ConcreteRevision#getIfcHeader <em>Ifc Header</em>}</li>
 *   <li>{@link store.ConcreteRevision#getBounds <em>Bounds</em>}</li>
 *   <li>{@link store.ConcreteRevision#getBoundsUntransformed <em>Bounds Untransformed</em>}</li>
 *   <li>{@link store.ConcreteRevision#getOidCounters <em>Oid Counters</em>}</li>
 *   <li>{@link store.ConcreteRevision#getMultiplierToMm <em>Multiplier To Mm</em>}</li>
 *   <li>{@link store.ConcreteRevision#getDensityCollection <em>Density Collection</em>}</li>
 * </ul>
 *
...
public interface ConcreteRevision extends IdEObject {
	 ...
	 * @see store.StorePackage#getConcreteRevision_Clear()
	 * @model
	 * @generated
	 */
	boolean isClear();
	...
	/**
	 * Sets the value of the '{@link store.ConcreteRevision#isClear <em>Clear</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getConcreteRevision_IfcHeader()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link store.ConcreteRevision#getIfcHeader <em>Ifc Header</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getConcreteRevision_Bounds()
	...
	/**
	 * Sets the value of the '{@link store.ConcreteRevision#getBounds <em>Bounds</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getConcreteRevision_BoundsUntransformed()
	 * @model annotation="dbembed"
	 *        annotation="embedsreference"
	 *        annotation="hidden"
	 * @generated
	...
	/**
	 * Sets the value of the '{@link store.ConcreteRevision#getBoundsUntransformed <em>Bounds Untransformed</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getConcreteRevision_OidCounters()
	 * @model
	 * @generated
	 */
	byte[] getOidCounters();
	...
	/**
	 * Sets the value of the '{@link store.ConcreteRevision#getOidCounters <em>Oid Counters</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getConcreteRevision_MultiplierToMm()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link store.ConcreteRevision#getMultiplierToMm <em>Multiplier To Mm</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see store.StorePackage#getConcreteRevision_DensityCollection()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link store.ConcreteRevision#getDensityCollection <em>Density Collection</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
